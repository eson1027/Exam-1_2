...
SC_MODULE(stim) {
  ...
  rdyvld_port_out<sc_fixed<11,2,SC_RND,SC_SAT> > o_a;
  ...
  rdyvld_port_in<sc_fixed<11,2,SC_RND,SC_SAT> > i_sum;
  //Store the previous inputs to FIFOs
  sc_fixed<11,2,SC_RND,SC_SAT> t_a;
  sc_uint<1> t_a_rdy;
  sc_uint<1> t_a_vld;
  //sc_uint<WIDTH> t_b;
  //sc_uint<1> t_b_rdy;
  ...
  void sink() {
    while(true) {
      ...
      //sum[j] = i_sum.read();
      //j++;
      //cout << "we already finished: "<<j<<" !"<<endl;
      wait();
    }
  ...
  void monitor() {
    cout << setw(14) << "time" << setw(14)<< "sum" << setw(14) << "sum rdy" 
         << setw(14) << "sum vld" << endl;
    while (true) {
      wait();
    //  t_a=o_a.msg.read();
    ...
    //  t_b_vld=o_b.vld.read();
      ...
      cout << setw(14) << sc_time_stamp();
      //cout << setw(14) << t_a.to_string(SC_DEC);
      //cout << setw(14) << t_a_rdy.to_string(SC_DEC);
      //cout << setw(14) << t_a_vld.to_string(SC_DEC);
      //cout << setw(14) << t_b.to_string(SC_BIN);
      //cout << setw(14) << t_b_rdy.to_string(SC_BIN);
      //cout << setw(14) << t_b_vld.to_string(SC_BIN);
      cout << setw(14) << t_sum.to_string(SC_DEC);
      cout << setw(14) << t_sum_rdy.to_string(SC_DEC);
      cout << setw(14) << t_sum_vld.to_string(SC_DEC) << endl;
      cout << "=========================================================================================" << endl;
    }
  }
